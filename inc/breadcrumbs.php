<?php
/**
 * Add a breadcrumb function for easy integration throughout the theme.
 *
 * Based on the code from: http://thewebtaylor.com/articles/wordpress-creating-breadcrumbs-without-a-plugin
 *
...
function the_breadcrumb () {
    ...
    // Settings
    $class      = 'breadcrumbs';
    $home_title = get_bloginfo( 'name', 'display' );
    ...
    if ( !is_front_page() ) {
        ...
        if ( is_single() ) {
            ...
            // Category page
            echo '<li class="item-current item-cat-' . $category[0]->term_id . ' item-cat-' . $category[0]->category_nicename . '">' . $category[0]->cat_name . '</li>';
            ...
            echo '<li class="item-current item-tag-' . $terms[0]->term_id . ' item-tag-' . $terms[0]->slug . '">' . $terms[0]->name . '</li>';
